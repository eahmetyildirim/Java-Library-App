...
public class arama extends javax.swing.JFrame {
    private String aranan=null;
    private String nearanacak=null;
    public arama() {
        initComponents();
    }
    public arama(String gelen,String reff) {
        initComponents();
        aranan=gelen;
        nearanacak=reff;
        //jTextArea1.setText(aranan+reff);
        bağlantı b = new bağlantı();
        List<Sinif> liste = b.ara2(nearanacak, aranan);
        int boyut=liste.size();
        for(int i=0;i<boyut;i++)
        {
         Sinif s=liste.get(i);
         jTextArea1.append(i+"->"+s.kitapadiGetir()+"  "+s.yazaradiGetir()+"  "+s.yilGetir()+"\n");
        }
    }
